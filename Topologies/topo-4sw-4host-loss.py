...
def Test():
    ...
    # Host-Switch Links
    # 10 MBps, 0ms delay, 0% loss, 1000 packet queue
    ...
    # Switch-Switch Links
    # 10MBps = 80Mbps, 0ms delay, 0% loss, 1000 packet queue
    net.addLink(s5, s6, bw=80, delay='0ms', loss=10, max_queue_size=1000, use_htb=True)
