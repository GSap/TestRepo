...
beginning i get port info which suggest that the current ports of the switch support 10GB-Copper. This is because in
...
# receiving link events.
    ...
    def calculateLoads(self, stamp):
        ...
        for l in self.Links:
            ...
            l.link_cost = ((l.last_load/5)/l.capacity)*100 # average the byte count over the polling period and then get percentage
